package net.oschina.ecust.improve.main.subscription;
...
import net.oschina.ecust.OSCApplication;
...
import net.oschina.ecust.improve.main.banner.EventHeaderView;
import net.oschina.ecust.improve.main.banner.HeaderView;
import net.oschina.ecust.improve.main.banner.NewsHeaderView;
    ...
    public void onItemClick(int position, long itemId) {
        ...
        switch (sub.getType()) {
            case News.TYPE_SOFTWARE:
                ...
                net.oschina.ecust.improve.detail.general.SoftwareDetailActivity.show(mContext, sub);
                break;
            case News.TYPE_QUESTION:
                //QuestionDetailActivity.show(mContext, sub.getId());
                net.oschina.ecust.improve.detail.general.QuestionDetailActivity.show(mContext, sub);
                break;
            case News.TYPE_BLOG:
                //BlogDetailActivity.show(mContext, sub.getId());
                net.oschina.ecust.improve.detail.general.BlogDetailActivity.show(mContext, sub);
                break;
            case News.TYPE_TRANSLATE:
                //TranslateDetailActivity.show(mContext, sub.getId());
                net.oschina.ecust.improve.detail.general.NewsDetailActivity.show(mContext, sub);
                break;
            case News.TYPE_EVENT:
                //EventDetailActivity.show(mContext, sub.getId());
                net.oschina.ecust.improve.detail.general.EventDetailActivity.show(mContext, sub);
                break;
            case News.TYPE_NEWS:
