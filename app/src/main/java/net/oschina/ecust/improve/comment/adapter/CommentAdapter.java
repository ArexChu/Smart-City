package net.oschina.ecust.improve.comment.adapter;
...
import net.oschina.ecust.improve.bean.comment.Vote;
import net.oschina.ecust.improve.behavior.CommentBar;
import net.oschina.ecust.improve.comment.CommentReferView;
import net.oschina.ecust.improve.comment.CommentsUtil;
