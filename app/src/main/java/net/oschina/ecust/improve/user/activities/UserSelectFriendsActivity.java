...
import net.oschina.ecust.improve.app.ParentLinkedHolder;
...
import net.oschina.ecust.improve.user.adapter.UserSearchFriendsAdapter;
import net.oschina.ecust.improve.user.adapter.UserSelectFriendsAdapter;
import net.oschina.ecust.improve.user.helper.ContactsCacheManager;
import net.oschina.ecust.improve.widget.RecentContactsView;
import net.oschina.ecust.ui.empty.EmptyLayout;
import net.oschina.ecust.util.TDevice;
import net.oschina.ecust.widget.IndexView;
