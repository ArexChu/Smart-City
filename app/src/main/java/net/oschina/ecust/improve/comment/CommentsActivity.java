...
import net.oschina.ecust.improve.comment.adapter.CommentAdapter;
...
import net.oschina.ecust.improve.widget.CommentShareView;
import net.oschina.ecust.improve.widget.RecyclerRefreshLayout;
...
import static net.oschina.ecust.R.id.tv_back_label;
