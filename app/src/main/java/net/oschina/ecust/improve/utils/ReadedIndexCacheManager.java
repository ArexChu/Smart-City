package net.oschina.ecust.improve.utils;
...
public class ReadedIndexCacheManager {
     ...
     * @param type    The Article Type {@link net.oschina.ecust.api.remote.OSChinaApi#CATALOG_NEWS}
     *                {@link net.oschina.ecust.api.remote.OSChinaApi#CATALOG_BLOG}
     * @return 已读位置
     */
     ...
     * @param context Context
     * @param id      The Article Id
     * @param type    The Article Type The Article Type {@link net.oschina.ecust.api.remote.OSChinaApi#CATALOG_NEWS}
     *                {@link net.oschina.ecust.api.remote.OSChinaApi#CATALOG_BLOG}
