package net.oschina.ecust.improve.user.activities;
...
import net.oschina.ecust.improve.base.activities.BaseRecyclerViewActivity;
...
import net.oschina.ecust.improve.behavior.KeyboardInputDelegation;
...
import net.oschina.ecust.improve.user.adapter.UserSendMessageAdapter;
import net.oschina.ecust.improve.user.helper.ContactsCacheManager;
import net.oschina.ecust.improve.utils.PicturesCompressor;
