...
import net.oschina.ecust.base.BaseApplication;
...
import net.oschina.ecust.improve.detail.db.DBManager;
import net.oschina.ecust.improve.main.location.BDLocationAdapter;
import net.oschina.ecust.improve.main.location.RadarSearchAdapter;
import net.oschina.ecust.improve.main.nav.NavFragment;
import net.oschina.ecust.improve.main.nav.NavigationButton;
import net.oschina.ecust.improve.main.update.CheckUpdateManager;
import net.oschina.ecust.improve.main.update.DownloadService;
import net.oschina.ecust.improve.notice.NoticeManager;
import net.oschina.ecust.improve.search.activities.NearbyActivity;
import net.oschina.ecust.improve.tweet.service.TweetNotificationManager;
...
import static net.oschina.ecust.improve.search.activities.NearbyActivity.LOCATION_PERMISSION;
