...
import net.oschina.ecust.improve.detail.apply.ApplyActivity;
import net.oschina.ecust.improve.detail.sign.SignUpActivity;
import net.oschina.ecust.improve.detail.v2.DetailActivity;
