        ...
        switch (host) {
            case "www.oschina.net":
                ...
                if (matcher.find()) {
                    ...
                    net.oschina.ecust.improve.detail.general.NewsDetailActivity.show(context, oid);
                    break;
                }
                ...
                if (matcher.find()) {
                    ...
                    net.oschina.ecust.improve.detail.general.QuestionDetailActivity.show(context, oid);
                    break;
                }
            ...
            case "my.oschina.net":
                ...
                if (matcher.find()) {
                    ...
                    net.oschina.ecust.improve.detail.general.BlogDetailActivity.show(context, oid);
                    break;
                }
