...
import net.oschina.ecust.improve.bean.NearbyResult;
import net.oschina.ecust.improve.bean.User;
import net.oschina.ecust.improve.bean.simple.Author;
import net.oschina.ecust.improve.search.adapters.NearbyUserAdapter;
...
import net.oschina.ecust.improve.widget.BottomDialog;
