...
import net.oschina.ecust.improve.media.SelectImageActivity;
...
import net.oschina.ecust.improve.user.activities.UserFollowsActivity;
import net.oschina.ecust.improve.user.activities.UserMessageActivity;
import net.oschina.ecust.improve.user.activities.UserTweetActivity;
import net.oschina.ecust.improve.user.collection.UserCollectionActivity;
import net.oschina.ecust.improve.user.event.UserEventActivity;
import net.oschina.ecust.improve.utils.DialogHelper;
import net.oschina.ecust.improve.utils.UiUtil;
import net.oschina.ecust.improve.widget.PortraitView;
import net.oschina.ecust.improve.widget.SolarSystemView;
import net.oschina.ecust.interf.OnTabReselectListener;
import net.oschina.ecust.ui.MyQRCodeDialog;
