package net.oschina.ecust.emoji;
...
import net.oschina.ecust.emoji.SoftKeyboardStateHelper.SoftKeyboardStateListener;
import net.oschina.ecust.improve.widget.TitleBar;
