...
import net.oschina.ecust.improve.utils.URLUtils;
import net.oschina.ecust.interf.OnWebViewImageListener;
import net.oschina.ecust.team.adapter.TeamMemberAdapter;
import net.oschina.ecust.team.bean.Team;
import net.oschina.ecust.team.bean.TeamActive;
...
import net.oschina.ecust.team.ui.TeamNewIssueActivity;
import net.oschina.ecust.ui.DetailActivity;
import net.oschina.ecust.ui.SimpleBackActivity;
import net.oschina.ecust.widget.AvatarView;
...
public class UIHelper {
    ...
    public static void showNewsDetail(Context context, long newsId,
                                      int commentCount) {
        net.oschina.ecust.improve.detail.general.NewsDetailActivity.show(context, newsId);
    }
    ...
    public static void showBlogDetail(Context context, long blogId) {
        net.oschina.ecust.improve.detail.general.BlogDetailActivity.show(context, blogId);
    }
    ...
    public static void showPostDetail(Context context, long postId, int count) {
        net.oschina.ecust.improve.detail.general.QuestionDetailActivity.show(context, postId);
    }
    ...
    public static void showEventDetail(Context context, long eventId) {
        net.oschina.ecust.improve.detail.general.EventDetailActivity.show(context, eventId);
    }
    ...
    public static void showSoftwareDetailById(Context context, int id) {
        net.oschina.ecust.improve.detail.general.SoftwareDetailActivity.show(context, id);
    }
    ...
    public static void showBannerDetail(Context context, Banner banner) {
        ...
        switch (banner.getType()) {
            ...
            case Banner.BANNER_TYPE_EVENT:
                net.oschina.ecust.improve.detail.general.EventDetailActivity.show(context, newsId);
                break;
...
//                    showTweetDetail(context, null, id);
    ...
    private static void showUrlRedirect(Context context, long id, String url) {
        if (url == null && id > 0) {
            net.oschina.ecust.improve.detail.general.NewsDetailActivity.show(context, id);
            return;
        }
