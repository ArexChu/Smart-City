...
import net.oschina.ecust.bean.NotebookData;
import net.oschina.ecust.bean.NotebookDataList;
import net.oschina.ecust.bean.SimpleBackPage;
import net.oschina.ecust.bean.User;
import net.oschina.ecust.db.NoteDatabase;
import net.oschina.ecust.improve.account.AccountHelper;
import net.oschina.ecust.team.adapter.NotebookAdapter;
import net.oschina.ecust.ui.empty.EmptyLayout;
import net.oschina.ecust.util.KJAnimations;
import net.oschina.ecust.util.SynchronizeController;
import net.oschina.ecust.util.SynchronizeController.SynchronizeListener;
import net.oschina.ecust.util.UIHelper;
import net.oschina.ecust.util.XmlUtils;
import net.oschina.ecust.widget.KJDragGridView;
import net.oschina.ecust.widget.KJDragGridView.OnDeleteListener;
import net.oschina.ecust.widget.KJDragGridView.OnMoveListener;
