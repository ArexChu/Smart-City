...
import net.oschina.ecust.team.bean.TeamIssueDetail;
import net.oschina.ecust.team.bean.TeamRepliesList;
import net.oschina.ecust.team.bean.TeamReply;
import net.oschina.ecust.team.bean.TeamReplyBean;
...
import net.oschina.ecust.util.TypefaceUtils;
import net.oschina.ecust.util.ViewUtils;
